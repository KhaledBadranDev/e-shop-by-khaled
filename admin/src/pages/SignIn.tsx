...
const SignIn: FC = () => {
    ...
    const adminReduxStateDispatch = useDispatch(); // "useDispatch"  to change the value of the global states
    // to access the admin global state using redux
    const adminRedux: IReduxAdminStateType = useSelector<
        IReduxRootStateType,
    ...
    const handelSignIn = useCallback(
        (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
            ...
            reduxSignInAsyncAPICallHelper(adminReduxStateDispatch, {
                email,
                password,
            });
        },
            ...
            <Wrapper>
                ...
                <Form>
                    ...
                    <Button
                        ...
                        disabled={adminRedux.isAsyncSigningIn}
                    >
                        Sign In
                    </Button>

                    {
                        ...
                        adminRedux.error.length > 0 && (
                            <Error>{adminRedux.error}</Error>
                        )
                    }
